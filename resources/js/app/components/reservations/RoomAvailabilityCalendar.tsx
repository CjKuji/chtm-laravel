...
export default function RoomAvailabilityCalendar({
  ...
  /* =========================================================
    DATE SELECTION VALIDATION (NON-CONSECUTIVE BLOCK)
    ========================================================= */
  // This calendar only indicates booked/free days.
  // Reservation attempt validation for non-consecutive dates will be enforced
  // at the booking start/end UI layer (ReservationModal) before saving.
  // Kept here intentionally to avoid duplicate/contradictory validation.
